...
from Sensor.entity.config_entity import TrainingPipelineConfig, DataValidationConfig, DataIngestionConfig
...
# pipeline = jarurat ke cheejeen + sequence
class TrainPipeline:
    ...
    def __init__(self):
        self.training_pipeline_config = TrainingPipelineConfig() # this will create an object of TrainingPipelineConfig


    def start_data_ingestion(self) -> DataIngestionArtifact: # this will return an object of DataIngestionArtifact
        try:
            self.data_ingestion_config = DataIngestionConfig(training_pipeline_config = self.training_pipeline_config) 
            # it creates an object of DataIngestionConfig and returns it

            logging.info("Starting data ingestion")
            data_ingestion = DataIngestion(data_ingestion_config = self.data_ingestion_config) # this will return an object of DataIngestion
            data_ingestion_artifact = data_ingestion.initiate_data_ingestion() # this will return an object of DataIngestionArtifact
